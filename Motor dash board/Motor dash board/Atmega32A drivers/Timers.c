...
void Timer2_Initiate(void)
{
	/*Set waveform generation mode, compare output mode and interrupt mode*/
		...
		#if    TIMER2_COMPARE_OUTPUT_MODE == TIMER2_TOGGLE_OC0_PIN
			CLEAR_BIT(TCCR2_REG,TCCR2_COM21_BIT);
			SET_BIT(TCCR2_REG,TCCR2_COM20_BIT);
			SET_BIT(DDRD_REG,PIN7); /*Set pin as output pin*/
		#elif TIMER2_COMPARE_OUTPUT_MODE == TIMER2_CLEAR_OC0_PIN
			SET_BIT(TCCR2_REG,TCCR2_COM21_BIT);
			CLEAR_BIT(TCCR2_REG,TCCR2_COM20_BIT);
			SET_BIT(DDRD_REG,PIN7); /*Set pin as output pin*/
		#elif TIMER2_COMPARE_OUTPUT_MODE == TIMER2_SET_OC0_PIN
			SET_BIT(TCCR2_REG,TCCR2_COM21_BIT);
			SET_BIT(TCCR2_REG,TCCR2_COM20_BIT);
			SET_BIT(DDRD_REG,PIN7); /*Set pin as output pin*/
		#elif TIMER2_COMPARE_OUTPUT_MODE == TIMER2_DISCONNECT_OC0
			CLEAR_BIT(TCCR2_REG,TCCR2_COM21_BIT);
			CLEAR_BIT(TCCR2_REG,TCCR2_COM20_BIT);
		#else
		...
		#if     TIMER2_COMPARE_OUTPUT_MODE == TIMER2_CLEAR_OC0_AT_UP_COUNT
			SET_BIT(TCCR2_REG,TCCR2_COM21_BIT);
			CLEAR_BIT(TCCR2_REG,TCCR2_COM20_BIT);
			SET_BIT(DDRD_REG,PIN7); /*Set pin as output pin*/
		#elif  TIMER2_COMPARE_OUTPUT_MODE == TIMER2_SET_OC0_AT_UP_COUNT
			SET_BIT(TCCR2_REG,TCCR2_COM21_BIT);
			SET_BIT(TCCR2_REG,TCCR2_COM20_BIT);
			SET_BIT(DDRD_REG,PIN7); /*Set pin as output pin*/
		#elif  TIMER2_COMPARE_OUTPUT_MODE == TIMER2_DISCONNECT_OC0
