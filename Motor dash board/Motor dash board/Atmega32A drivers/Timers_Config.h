...
*/
#define TIMER1_COMPARE_OUTPUT_MODE_OC1B	(TIMER1_NON_INVERTING_MODE_OC1B)
...
/*
 * TIMER2_COMPARE_OUTPUT_MODE (For non PWM-modes)  : TIMER2_TOGGLE_OC0_PIN		    TIMER2_CLEAR_OC0_PIN		TIMER2_SET_OC0_PIN		TIMER2_DISCONNECT_OC0
 * TIMER2_COMPARE_OUTPUT_MODE (For Fast-PWM-mode)  : TIMER2_NON_INVERTING_MODE		TIMER2_INVERTING_MODE	    TIMER2_DISCONNECT_OC0
 * NOTE : NON_INVERTING_MODE --> Clear OC0 on compare match, set OC0 at BOTTOM.
 * 		  INVERTING_MODE     --> Set OC0 on compare match, clear OC0 at BOTTOM.
 * TIMER2_COMPARE_OUTPUT_MODE (For Phase-correct-PWM-mode)  : TIMER2_CLEAR_OC0_AT_UP_COUNT	TIMER2_SET_OC0_AT_UP_COUNT	TIMER2_DISCONNECT_OC0
 */
