	...
	switch(MyStepper->StepperMode)
	{
		case STEPPER_FULL_STEP_MODE:
									...
									if(Direction == STEPPER_CW)
									{
										...
										{
											/*step 1*/
											DIO_WritePin(MyStepper->StepperPort,MyStepper->Coil1Pin,DIO_LOW_PIN);
											DIO_WritePin(MyStepper->StepperPort,MyStepper->Coil2Pin,DIO_HIGH_PIN);
											DIO_WritePin(MyStepper->StepperPort,MyStepper->Coil3Pin,DIO_HIGH_PIN);
											DIO_WritePin(MyStepper->StepperPort,MyStepper->Coil4Pin,DIO_HIGH_PIN);
											_delay_ms(STEPPER_DELAY_MS);
											/*step 2*/
											DIO_WritePin(MyStepper->StepperPort,MyStepper->Coil1Pin,DIO_HIGH_PIN);
											DIO_WritePin(MyStepper->StepperPort,MyStepper->Coil2Pin,DIO_LOW_PIN);
											DIO_WritePin(MyStepper->StepperPort,MyStepper->Coil3Pin,DIO_HIGH_PIN);
											DIO_WritePin(MyStepper->StepperPort,MyStepper->Coil4Pin,DIO_HIGH_PIN);
											_delay_ms(STEPPER_DELAY_MS);
											/*step 3*/
											DIO_WritePin(MyStepper->StepperPort,MyStepper->Coil1Pin,DIO_HIGH_PIN);
											DIO_WritePin(MyStepper->StepperPort,MyStepper->Coil2Pin,DIO_HIGH_PIN);
											DIO_WritePin(MyStepper->StepperPort,MyStepper->Coil3Pin,DIO_LOW_PIN);
											DIO_WritePin(MyStepper->StepperPort,MyStepper->Coil4Pin,DIO_HIGH_PIN);
											_delay_ms(STEPPER_DELAY_MS);
											/*step 4*/
											DIO_WritePin(MyStepper->StepperPort,MyStepper->Coil1Pin,DIO_HIGH_PIN);
											DIO_WritePin(MyStepper->StepperPort,MyStepper->Coil2Pin,DIO_HIGH_PIN);
											DIO_WritePin(MyStepper->StepperPort,MyStepper->Coil3Pin,DIO_HIGH_PIN);
											DIO_WritePin(MyStepper->StepperPort,MyStepper->Coil4Pin,DIO_LOW_PIN);
											_delay_ms(STEPPER_DELAY_MS);
										}
									}
