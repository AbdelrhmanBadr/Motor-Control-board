...
#define TIMER2_TOGGLE_OC0_PIN		(0X01)
#define TIMER2_CLEAR_OC0_PIN		(0X02)
#define TIMER2_SET_OC0_PIN			(0X03)
#define TIMER2_DISCONNECT_OC0		(0X04)
...
#define TIMER2_CLEAR_OC0_AT_UP_COUNT	(0X02)
#define	TIMER2_SET_OC0_AT_UP_COUNT	    (0X03)
